...
public class SceneRecognitionActivity extends AppCompatActivity {
    ...
    String TAG = "SceneRecognitionActiv";
    ...
    private BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (bundle != null
                ...
                Log.i(TAG, "SceneRecognitionActivity: BroadcastReceiver");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnSelectImage = (Button) findViewById(R.id.btn_scnRek_select_image);
        ...
        mBtnRecognize = (Button) findViewById(R.id.btn_scnRek_recognize);
        ...
        // =========
        mBtnAutorun = (Button) findViewById(R.id.btn_scnRek_autorun);
    ...
    private void onclick_btn_recognize(View v) {
        if (mPicturePath != null) {
            if (mTxtResult.getText() != "") {
                Log.i(TAG, "mTxtResult.getText() is not empty.");
            ...
            intent.putExtra(ExecutionEngineService.LOCALSERVICEREQUEST,
                    "com.simplicity.maged.mccobjectdetection.services.SceneRecognitionService");
    ...
    protected void onClick_Autorun(View v) {
        // milliseconds
        final long interval = 1000 * Long.parseLong(mTxt_interval.getText()
                .toString());
        final long ticks = Long.parseLong(mTxtTicks.getText().toString()) + 1;
        mTxtActualTicks.setText("0");
        if (mCounterDownTimer == null && interval > 0 && ticks > 0) {
            ...
            mCounterDownTimer = new CountDownTimer(interval * ticks, interval) {
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    if (currentTick % 20 == 0) {
                        String s = "";
                        switch ((int) currentTick / 20) {
                        /* case 1:
                            s = "/storage/extSdCard/simplicity/images/jpeg/Image_1MB.jpg";
							break; */
                            case 1:
                                // s = "/storage/extSdCard/simplicity/images/jpeg/Image_2MB.jpg";
                                break;
                        /* case 3:
                            s = "/storage/extSdCard/simplicity/images/jpeg/Image_4MB.jpg";
							break;*/
                            default:
                                break;
                        }
